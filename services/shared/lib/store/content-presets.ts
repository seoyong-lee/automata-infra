...
export const BUILTIN_CONTENT_PRESETS: ContentPreset[] = [
  ...
  createBuiltInPreset({
    ...
    promptOverrides: {
      jobPlan: {
        systemPrompt: [
          "You are a factual Korean short-form video planning assistant.",
          "",
          "Return valid JSON only.",
          'The JSON schema must be {"titleIdea": string, "targetDurationSec": number, "stylePreset": string}.',
          "Create plans that feel like grounded documentary or explainer shorts with a clear factual payoff.",
          "Avoid sensational mystery framing, vague philosophy, or exaggerated clickbait.",
        ].join("\n"),
        userPrompt: [
          "Create one Korean short-form video plan for a documentary-style explainer preset.",
          "",
          'Return JSON with keys: "titleIdea", "targetDurationSec", "stylePreset".',
          "Requirements:",
          "- Keep the concept concrete, factual, and curiosity-driven.",
          "- Favor hidden mechanisms, history, science, or human-behavior facts with a clear reveal.",
          "- Avoid abstract worldview titles or broad metaphysical framing.",
          "- targetDurationSec must be an integer between 30 and 60.",
          "- stylePreset must be a concise snake_case label for documentary narration tone.",
          "",
          "Inputs:",
          "- contentId: {{contentId}}",
      ...
      sceneJson: {
        systemPrompt: [
          "You are a Korean documentary short-form scene writer.",
          "",
          "Return valid JSON only.",
          "Write a scene JSON document that is factual, tightly paced, and easy to narrate with TTS.",
          "Narration must feel consistent from scene to scene and should avoid dramatic fiction-style storytelling.",
        ].join("\n"),
        userPrompt: [
          "Create a Korean scene JSON document for a documentary/explainer short.",
          "",
          'Return JSON with keys: "videoTitle", "language", "scenes".',
          "Rules:",
          "- Create 5 to 7 scenes.",
          "- Prefer 6 to 8 seconds per scene unless the fact strongly needs a shorter beat.",
          "- narration and subtitle must be exactly identical.",
          "- Keep narration concise, factual, and consistent in tone.",
          "- Favor observation-first, mechanism-driven explanation over dramatic flourish.",
          "- Every visual prompt must target vertical 9:16 composition.",
          "",
          "Inputs:",
          "- titleIdea: {{titleIdea}}",
          "- targetLanguage: {{targetLanguage}}",
