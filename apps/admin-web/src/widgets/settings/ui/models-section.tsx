      ...
      <div className="rounded-xl border border-admin-outline-ghost/10 bg-white p-6 shadow-sm">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              {mutation.isPending ? t('saveWorkspacePending') : t('saveWorkspace')}
            </Button>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-12 gap-6">
          ...
          <div className="rounded-xl border border-admin-outline-ghost/10 bg-white p-8 shadow-sm">
            <div className="mb-6 flex items-center justify-between">
              ...
              <span className="rounded bg-admin-surface-section px-2 py-1 font-mono text-[10px] text-admin-text-muted">
                {t('tokens', { count: tokenCount.toLocaleString() })}
              </span>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between rounded-lg bg-white p-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm font-bold text-admin-text-strong">{t('promptVersion')}</p>
                    <p className="text-xs text-admin-text-muted">
                      {form.promptVersion || t('noVersionTag')}
                    </p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between rounded-lg bg-white p-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm font-bold text-admin-text-strong">{t('secretEnvVar')}</p>
                    <p className="text-xs text-admin-text-muted">
                      {form.secretIdEnvVar || t('noSourceAttached')}
                    </p>
                  </div>
                </div>
        ...
        <div className="col-span-12 space-y-6 xl:col-span-4">
          ...
          <Card className="border-admin-outline-ghost/10 bg-white shadow-sm">
            <CardContent className="space-y-8 p-6">
              <h3 className="text-xs font-bold uppercase tracking-[0.24em] text-admin-text-muted">
                {t('inferenceParameters')}
              </h3>

              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <label className="text-sm font-semibold text-admin-primary">{t('temperature')}</label>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <label className="text-sm font-semibold text-admin-primary">{t('maxTokens')}</label>
                  <span className="rounded bg-indigo-50 px-2 py-0.5 font-mono text-xs font-bold text-indigo-600">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <label className="text-sm font-semibold text-admin-primary">{t('topP')}</label>
                  <span className="rounded bg-indigo-50 px-2 py-0.5 font-mono text-xs font-bold text-indigo-600">
                    1.0
                  </span>
                </div>
          ...
          <div className="relative overflow-hidden rounded-xl bg-indigo-900 p-6 shadow-2xl">
            ...
            <h4 className="text-sm font-bold text-white">{t('needAssistance')}</h4>
