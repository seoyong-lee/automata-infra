...
export class AppStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: AppStackProps) {
    ...
    const runSourceVideoFrameExtractResolver = generationsHandler;
    const runSourceVideoSceneJsonResolver = generationsHandler;
    ...
    this.jobsTable.grantReadData(pushJobRenderSettingsToContentPresetResolver);
    this.assetsBucket.grantRead(pushJobRenderSettingsToContentPresetResolver);
    ...
    const adminGraphql = createPublishGraphqlApi(this, {
      ...
      runSourceVideoFrameExtractResolver,
      runSourceVideoSceneJsonResolver,
